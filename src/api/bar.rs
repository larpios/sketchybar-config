...
impl ToSketchybarArgs for Bar {
    fn to_sketchybar_args(&self) -> Vec<Property> {
        vec![
            Property::new("color", self.color),
            Property::new("border_color", self.border_color),
            Property::new("position", self.position),
            Property::new("height", self.height),
            Property::new("notch_display_height", self.notch_display_height),
            Property::new("margin", self.margin),
            Property::new("y_offset", self.y_offset),
            Property::new("corner_radius", self.corner_radius),
            Property::new("border_width", self.border_width),
            Property::new("blur_radius", self.blur_radius),
            Property::new("padding_left", self.padding_left),
            Property::new("padding_right", self.padding_right),
            Property::new("notch_width", self.notch_width),
            Property::new("notch_offset", self.notch_offset),
            Property::new("display", self.display.clone()),
            Property::new("hidden", self.hidden),
            Property::new("topmost", self.topmost),
